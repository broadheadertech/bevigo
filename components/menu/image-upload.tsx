        ...
        <div className="relative w-full h-32 rounded-xl overflow-hidden" style={{ backgroundColor: 'var(--muted)' }}>
          ...
          <div className="absolute inset-0 bg-black/0 hover:bg-black/40 transition-colors flex items-center justify-center gap-2 opacity-0 hover:opacity-100">
            <button
              ...
              className="px-3 py-1.5 bg-white/90 text-stone-900 text-xs font-medium rounded-lg"
            >
              Change
            </button>
            <button
              ...
              disabled={isUploading}
              className="px-3 py-1.5 bg-red-500/90 text-white text-xs font-medium rounded-lg"
            >
              Remove
            </button>
          </div>
