  ...
  return (
    <Link href="/inventory">
      <div
        className={
          isCritical
            ? "bg-red-50 border border-red-200 text-red-700 rounded-xl px-4 py-3 mb-6 flex items-center justify-between cursor-pointer hover:bg-red-100 transition-colors"
            : "bg-amber-50 border border-amber-200 text-amber-800 rounded-xl px-4 py-3 mb-6 flex items-center justify-between cursor-pointer hover:bg-amber-100 transition-colors"
        }
      >
