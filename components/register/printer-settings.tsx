...
export function PrinterSettings() {
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-2xl transition-colors"
 ...
 return (
 <div className="absolute top-12 right-4 z-40 w-72 rounded-2xl border shadow-lg p-4" style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border-color)' }}>
 <div className="flex items-center justify-between mb-3">
 <h3 className="text-sm font-semibold" style={{ color: 'var(--fg)' }}>Printer</h3>
 <button
 type="button"
 ...
 {/* Error */}
 {error && (
 <div className="mb-3 p-2 bg-red-500/10 border border-red-500/20 text-red-400 rounded-xl text-xs">
 {error}
 </div>
 )}
 ...
 className="flex-1 px-3 py-2 text-xs font-medium text-white rounded-xl disabled:opacity-50 transition-colors"
 >
 ...
 disabled={isTesting}
 className="w-full mb-3 px-3 py-2 text-xs font-medium rounded-xl disabled:opacity-50 transition-colors"
 >
 ...
 />
 <label htmlFor="autoPrint" className="text-xs">
