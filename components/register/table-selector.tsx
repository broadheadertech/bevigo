...
export function TableSelector({
 ...
 className="w-full py-2 text-sm rounded-xl transition-colors flex items-center justify-center gap-2"
 ...
 <div
 className="absolute left-0 right-0 top-full z-50 mt-1 rounded-2xl shadow-2xl overflow-hidden max-h-80 overflow-y-auto"
 style={{
 ...
 !selectedTableId ?"bg-amber-500/10 text-amber-400" :""
 }`}
