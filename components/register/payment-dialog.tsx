...
export function PaymentDialog({
 ...
 <div className="rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden" style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border-color)' }}>
 {/* Header */}
 ...
 className="text-stone-400 text-xl leading-none p-1 disabled:opacity-50"
 >
 &#10005;
 </button>
 </div>
 ...
 disabled={isProcessing}
 className="flex flex-col items-center justify-center gap-2 min-h-[80px] min-w-[80px] rounded-xl border-2 hover:border-green-500 hover:bg-green-500/10 active:bg-green-500/15 disabled:opacity-50 disabled:cursor-not-allowed transition-colors p-4"
 >
