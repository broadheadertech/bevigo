  ...
  if (step === "success") {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
        <div className="flex flex-col items-center rounded-2xl bg-neutral-900 p-8 text-white shadow-xl">
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
        <div className="w-full max-w-md rounded-2xl bg-neutral-900 p-6 text-white shadow-xl">
          <h2 className="text-xl font-bold mb-2">Void Order</h2>
          <p className="text-neutral-400 mb-6">
            Enter the reason for voiding this order.
          </p>

          <label htmlFor="void-reason" className="block text-sm font-medium mb-2">
            Void Reason <span className="text-red-400">*</span>
          </label>
          <textarea
            id="void-reason"
            className="w-full rounded-lg border border-neutral-700 bg-neutral-800 px-4 py-3 text-white placeholder-neutral-500 focus:border-stone-500 focus:outline-none focus:ring-1 focus:ring-stone-500"
            rows={3}
          ...
          <div className="mt-6 flex gap-3">
            <button
              type="button"
              className="flex-1 rounded-lg bg-neutral-700 px-4 py-3 text-base font-semibold hover:bg-neutral-600 active:bg-neutral-500 transition-colors min-h-[48px]"
              onClick={() => {
                setStep("pin");
                setPin("");
                setError(null);
            ...
            <button
              type="button"
              className="flex-1 rounded-lg bg-red-700 px-4 py-3 text-base font-semibold hover:bg-red-600 active:bg-red-500 transition-colors min-h-[48px] disabled:opacity-50"
