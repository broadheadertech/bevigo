        ...
        <div className="border-t border-stone-200 px-4 py-3 space-y-3">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex-1 min-h-[48px] px-4 py-3 rounded-lg bg-amber-600 text-white font-medium hover:bg-amber-700 active:bg-amber-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              Add to Order
            </button>
          </div>
