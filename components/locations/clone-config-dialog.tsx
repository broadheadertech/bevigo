...
export function CloneConfigDialog({ onClose }: CloneConfigDialogProps) {
 ...
 <div className="rounded-2xl shadow-2xl w-full max-w-lg p-6 max-h-[80vh] flex flex-col border" style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border-color)' }}>
 <h2 className="text-lg font-bold mb-4" style={{ color: 'var(--fg)' }}>Clone Location Configuration</h2>
 ...
 className="px-4 py-2.5 rounded-xl text-sm font-medium transition-colors" style={{ color: 'var(--muted-fg)' }}
 >
 Back
 </button>
 <button
 ...
 type="button"
 onClick={onClose}
 className="px-4 py-2.5 text-white rounded-xl text-sm font-medium transition-colors"
 >
 Done
 </button>
 </div>
