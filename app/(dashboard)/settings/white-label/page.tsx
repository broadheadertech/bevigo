...
export default function WhiteLabelSettingsPage() {
 ...
 return (
 <div className="flex items-center justify-center h-64">
 <p style={{ color: 'var(--muted-fg)' }}>Only owners can access white-label settings.</p>
 </div>
 );
 }
 ...
 <div>
 <div className="mb-8">
 <h1 className="text-xl font-bold" style={{ color: 'var(--fg)' }}>White-Label</h1>
 ...
 <div>
 <h2 className="text-base font-semibold text-amber-400" style={{ color: 'var(--fg)' }}>White-Label Available</h2>
 ...
 <h2 className="text-base font-semibold mb-4" style={{ color: 'var(--fg)' }}>What&apos;s Included</h2>
 ...
 {/* Contact CTA */}
 <div className="rounded-2xl border shadow-lg p-6 text-center" style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border-color)' }}>
 <p className="text-sm mb-3">
 Interested in the full white-label experience?
 </p>
 <a
 href="mailto:support@bevigo.app?subject=White-Label%20Inquiry"
 className="inline-flex items-center gap-2 px-4 py-2.5 text-white text-sm font-medium rounded-xl transition-colors"
 >
