...
export default function ReportSchedulePage() {
 ...
 {/* Settings form */}
 <div className="rounded-2xl border shadow-lg p-6 max-w-lg">
 ...
 onClick={handleSave}
 disabled={saving}
 className="bg-stone-900 text-white px-5 py-2.5 rounded-xl text-sm font-medium disabled:opacity-50 transition-colors"
 >
