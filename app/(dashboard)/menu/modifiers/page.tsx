...
export default function ModifiersPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold" style={{ color: 'var(--fg)' }}>Modifier Groups</h1>
 ...
 className="px-4 py-2 text-white rounded-2xl transition-colors"
 >
 + Add Group
 </button>
 </div>
 ...
 {group.required && (
 <span className="text-xs px-2 py-0.5 bg-red-500/15 text-red-400 rounded-full font-medium">
 Required
 </span>
 )}
 </div>
