      ...
      <div className="flex gap-6">
        ...
        <div className="w-56 shrink-0">
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              All Items
              <span className={`ml-1.5 text-xs ${selectedCategoryId === null && !showFeaturedOnly ? "text-stone-400" : "text-stone-400"}`}>
                {typedItems.length}
              </span>
            </button>
            <button
              ...
              return (
                <div key={cat._id} className="flex items-center group">
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 text-xs text-stone-400 hover:text-amber-700 px-1 transition-opacity"
                    title="Edit category"
                  >
                    Edit
                  </button>
          ...
          {typedCategories.length === 0 && items !== undefined && (
            <p className="text-sm text-stone-400 mt-2 px-1">
