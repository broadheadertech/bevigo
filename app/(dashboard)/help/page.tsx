  ...
  return (
    ...
    >
      <button
        ...
        className="flex w-full items-center justify-between gap-4 px-4 py-3.5 text-left text-sm font-medium transition-colors hover:bg-stone-50 dark:hover:bg-stone-800/50"
