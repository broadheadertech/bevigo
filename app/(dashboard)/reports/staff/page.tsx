              ...
              <tr>
                {(
                  ...
                  <th
                    ...
                    className={`${col.key === "userName" || col.key === "role" ? "text-left" : "text-right"} px-5 py-3 text-xs font-medium text-stone-400 uppercase tracking-wide cursor-pointer hover:text-stone-600 select-none`}
                  >
                    {col.label}
