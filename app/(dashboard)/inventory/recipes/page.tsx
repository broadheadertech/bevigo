...
export default function RecipesPage() {
 ...
 <div key={catName}>
 <p className="text-xs font-medium px-3 mb-1">
 {catName}
 </p>
 ...
 {!selectedItemId ? (
 <div className="flex items-center justify-center h-64 rounded-2xl border shadow-lg">
