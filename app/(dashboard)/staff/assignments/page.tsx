...
export default function StaffAssignmentsPage() {
 ...
 return (
 <div className="flex items-center justify-center h-64">
 <p style={{ color: 'var(--muted-fg)' }}>Only owners can manage staff-location assignments.</p>
 </div>
 );
 }
 ...
 return (
 <div className="flex items-center justify-center h-64">
 <p style={{ color: 'var(--muted-fg)' }}>Loading assignment matrix...</p>
 </div>
 );
 }
 ...
 <div>
 <h1 className="text-2xl font-bold" style={{ color: 'var(--fg)' }}>Staff-Location Assignments</h1>
 ...
 className="px-4 py-2 text-white rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
 >
 ...
 className="w-5 h-5 rounded focus:ring-blue-500 cursor-pointer disabled:cursor-not-allowed"
 />
 </td>
 );
 })}
